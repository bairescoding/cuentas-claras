...
- **Aesthetics**: Premium, rich aesthetics. Use vibrant colors, sleek dark modes, modern typography, and smooth micro-animations. Follow the guidelines in `.agent/skills/frontend-design/SKILL.md` for all UI/UX work.
